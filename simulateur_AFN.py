...
def create_widgets():
    ...
    for i in range(1,etats+1):
        ...
        if i in etat_initial:
            states.append(canvas.create_oval(x-25, y-25, x+25, y+25, fill="white",tags="final" if i in etat_final else "", outline='#28AAFF'))
        else:
...
# respectivement. Le programme affiche ensuite le chemin à l'aide du module matplotlib. La liste 
# n_success enregistre le nombre de transitions réussies consécutives effectuées par l'automate. Ces 
# informations sont utilisées pour colorer les bords dans le graphique matplotlib.
